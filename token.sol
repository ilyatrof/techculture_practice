...
contract Token {
    ...
    string public name = "SCAM TOKEN WITH MODIFIER CLASSIC";
    string public symbol = "STWMC";
  ...
  function addBlacklist(address account) external virtual notInBlacklist(account) {
    blacklist[account] = true;

  }
 
  function revokeBlacklist(address account) external virtual inBlacklist(account) {
    ...
    function transfer(address recipient, uint amount) notInBlacklist(recipient) external returns(bool) {
